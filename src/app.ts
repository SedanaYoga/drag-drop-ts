...
class ProjectState extends State<Project> {
  ...
  addProject(title: string, description: string, numOfPeople: number) {
    const newProject = new Project(
      ...
      description,
      numOfPeople,
      ProjectStatus.Active // new project default status being Active
    )
...
const projectState = ProjectState.getInstance() // Singleton, calling only one static method of a class
...
class ProjectInput extends Component<HTMLDivElement, HTMLFormElement> {
  ...
  private submitHandler(event: Event) {
    ...
    if (Array.isArray(userInputs)) {
      ...
      projectState.addProject(title, description, people) // projectState is a global variable
      this.clearInputs()
    }
  }
}
